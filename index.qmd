...
> In particular, it is a linear regression model that aims to examine the
> impact of country--movie relatedness density (∅), movie ubiquity (U), and
> other covariates (Z) on the entry of a movie into the top 20 list of a
> given country at period t+1.
...
### **Country-Specific OTT Content Launching Maps**: United States (December 2021)
...
### **Country-Specific OTT Content Launching Maps**: South Korea
...
-   <https://changjunlee.com/blogs/posts/>
